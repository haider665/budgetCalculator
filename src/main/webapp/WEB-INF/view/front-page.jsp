...
<body>
    ...
    <div class="main">
		<div align="center"><h1>Welcome to Budget Calculator App</h1></div>
        <!-- Sign up form -->
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form:form action="signUp" method="POST" class="register-form" id="register-form" modelAttribute="haider">
...
<!--                             </div> -->
                    ...
                    <div class="signup-image">
                        ...
                        <a href="#haider" class="signin-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="signin-content">
                    ...
                    <div class="signin-form">
                        <h2 class="form-title"><a name="haider">Sign in</h2>
                        <form:form action="logIn" method="POST" class="register-form" id="login-form" modelAttribute="haider">
                            <div class="form-group">
                                <label for="your_name"><i class="zmdi zmdi-email"></i></label>
                                <form:input type="text" name="your_name" id="your_name" placeholder="Your email" path="email"/>
                            </div>
                            <div class="form-group">
